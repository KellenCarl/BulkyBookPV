...
namespace BulkyBook.Areas.Customer.Controllers
{
    ...
    public class CartController : Controller
    {
        ...
        public async Task<IActionResult> IndexPOST()
        {
            ...
            if(user ==null)
            {
                ModelState.AddModelError(string.Empty, "Verification E-mail is empty!");
            }
            ...
            ModelState.AddModelError(string.Empty, "Verification E-mail sent.  Please check your E-mail");
        ...
        public IActionResult Minus(int cartId)
        {
            ...
            if (cart.Count == 1)
            {
                var sessionCount = _unitOfWork.ShoppingCart.GetAll(u => u.ApplicationUserId == cart.ApplicationUserId).ToList().Count();
                _unitOfWork.ShoppingCart.Remove(cart);
                _unitOfWork.Save();
                HttpContext.Session.SetInt32(SD.ssShoppingCart, sessionCount - 1);
            }
            else
            {
                cart.Count -= 1;
        ...
        public IActionResult SummaryPost(string stripeToken)
        {
            ...
            else
            {
                ...
                {
                    ShoppingCartVM.OrderHeader.TransacationId = charge.Id; 
                }
        ...
        public IActionResult OrderConfirmation(int id)
        {
            ...
            try
            {
                var message = MessageResource.Create(
                  body: "Order has been placed on Bulky Book.  Your Order ID:" + id,
